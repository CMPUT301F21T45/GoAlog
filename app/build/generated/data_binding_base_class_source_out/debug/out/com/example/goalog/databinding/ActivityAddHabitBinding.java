...
public final class ActivityAddHabitBinding implements ViewBinding {
  ...
  @NonNull
  public final TextView activityAddHabitTitle;
  ...
  private ActivityAddHabitBinding(@NonNull LinearLayout rootView,
      @NonNull TextView activityAddHabitTitle, @NonNull CheckBox checkboxPrivacyAdd,
      @NonNull Button confirmButtonHabit, @NonNull TextView displayStartDateAddHabit,
      @NonNull CheckBox friCheckbox, @NonNull EditText habitReason, @NonNull EditText habitTitle,
      @NonNull CheckBox monCheckbox, @NonNull CheckBox satCheckbox,
      @NonNull Button selectDateAddHabit, @NonNull CheckBox sunCheckbox,
      @NonNull CheckBox thuCheckbox, @NonNull CheckBox tueCheckbox, @NonNull CheckBox wedCheckbox) {
    this.rootView = rootView;
    this.activityAddHabitTitle = activityAddHabitTitle;
  ...
  public static ActivityAddHabitBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.activity_add_habit_title;
      TextView activityAddHabitTitle = ViewBindings.findChildViewById(rootView, id);
      if (activityAddHabitTitle == null) {
        break missingId;
      }
      ...
      return new ActivityAddHabitBinding((LinearLayout) rootView, activityAddHabitTitle,
          checkboxPrivacyAdd, confirmButtonHabit, displayStartDateAddHabit, friCheckbox,
          habitReason, habitTitle, monCheckbox, satCheckbox, selectDateAddHabit, sunCheckbox,
          thuCheckbox, tueCheckbox, wedCheckbox);
    }

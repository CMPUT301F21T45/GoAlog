...
public class HabitList extends AppCompatActivity /*implements AddHabitActivityConfirmListener*/{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final CollectionReference collectionReference = database.collection("Habit");

        Button buttonAddHabit = (Button) findViewById(R.id.add_habbit_button);
        ...
        collectionReference.addSnapshotListener(new EventListener<QuerySnapshot>() {
            ...
            public void onEvent(
                ...
                for (QueryDocumentSnapshot doc:queryDocumentSnapshots) {
                    ...
                    // Adding the habits and provinces from FireStore
...
/*
    @Override
    public void onConfirmPressed(Habit newHabit){
